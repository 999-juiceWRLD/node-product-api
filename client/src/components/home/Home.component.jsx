export const Home = () => {
    return (
        <div>
            <h1 className="pb-3">welcome 🖐️</h1>
            <p>I did this website, you can refer to my <a rel="noreferrer" href="https://github.com/999-juiceWRLD" target="_blank">github</a> account.</p>
            <div className="my-2">
                <p>
